...
module "my_custom_sg_module" {
  source          = "./terraform_modules/sg_module"
  vpc_id          = var.vpc_id
...
module "my_custom_web_tier_module" {
  source = "./terraform_modules/web_tier_module"
  vpc_id = var.vpc_id
  web_tier_sg_id = var.web_tier_sg_id
  pub_sub1_id = var.pub_sub1_id
  pub_sub2_id = var.pub_sub2_id
...
module "my_custom_bastion_module" {
  source = "./terraform_modules/bastion_module"
